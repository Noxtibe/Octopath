...
/**
 * A component that sets up the combat scene by positioning the player,
...
public:
	...
	// Adjust this so that the camera is high above, with the player in the bottom-right and enemies in the top-left.
